        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "and a Readme.md and MIT license files Use index.html as name of main file. Use README.md as name of readme file. Use LICENSE as name of license file.The code generated by you will be deployed on github using github pages.json.dump will be used to your response so write accordinly"
                )
            },
...
def run_task(data: dict):
    ...
    if task_round == 1:
        ...
        pages_url = f"https://api.github.com/repos/23f3004092/{repo_name}/pages"
        live_url =f" https://23f3004092.github.io/{repo_name}/"
...
def check_host(hostname: str):
    try:
        # 1️⃣ Try to resolve hostname to IP
        ip = socket.gethostbyname(hostname)
    except socket.gaierror:
        return {"hostname": hostname, "reachable": False, "error": "DNS resolution failed"}

    try:
        # 2️⃣ Optional: Try a GET request (timeout 5 seconds)
